...
- Current repo docs HEAD на branch `codex/native-ios-companion`: `99172cd171e8cade0545fb442c9233961c7865d1`.
...
- Trigger fix уже действует на `origin/master` с `c0682493c93ac2d8ff1d31bca9e1b1c2546b3c56` (2026-08-24): Android/Backend/Web success runs `32766368686` / `32766368744` / `32766368663`, без iOS/deploy/publish. Candidate `99172cd` имеет эквивалент через `0bbf4acb`; старые другие branches автоматически не исправлены; [[MOC_DevOps]].
...
- [`ios/README.md`](https://github.com/DmtrGoltsev/RocketFlow/blob/99172cd171e8cade0545fb442c9233961c7865d1/ios/README.md) — living toolchain и local/CI commands.
...
- [`AGENTS.md`](https://github.com/DmtrGoltsev/RocketFlow/blob/99172cd171e8cade0545fb442c9233961c7865d1/AGENTS.md) — актуальные agent instructions.
