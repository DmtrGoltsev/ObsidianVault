...
уверенность: "высокая"
источники: [".github/workflows/backend-verify.yml", "backend package 2026-06-08", "docs/68-scroll-and-priority-retirement-delivery.md"]
доказательства: ["Док_Backend_Verification", "Док_V21_Scroll_Priority_20260822"]
...
- Покрытие включает auth, accounts, folders, goals, tasks, sharing, calendar, recurrence, reminders, notifications и legacy priority compatibility без product decay behavior. Current V21 candidate suite `142/142` PASS; см. [[Док_Backend_Verification]].
