...
- [[Goal]] — цель
- [[Task]] — задача
- [[RocketFlow/01_Человеку/Глоссарий/Green_Task|Green_Task]] — зелёная задача
- [[RocketFlow/01_Человеку/Глоссарий/Red_Task|Red_Task]] — красная задача
- [[Tag]] — тег
- [[Task_Link]] — связь между задачами
- [[Planned_Time]] — плановое время
- [[Due_Time]] — срок выполнения
- [[RocketFlow/01_Человеку/Глоссарий/Reminder_Rule|Reminder_Rule]] — правило напоминания
- [[RocketFlow/01_Человеку/Глоссарий/Recurrence_Rule|Recurrence_Rule]] — правило повторения
- [[Reschedule_Event]] — событие переноса
- [[RocketFlow/01_Человеку/Глоссарий/Priority_Decay|Priority_Decay]] — выведенный из продукта legacy-механизм; compatibility shadow до завершения V20/old APK support
...
- [[RocketFlow/01_Человеку/Источники/Источник_README|Источник_README]] — README проекта
- [[Источник_MVP_План]] — план MVP
- [[Источник_Спецификация_Домена]] — спецификация домена
- [[RocketFlow/01_Человеку/Источники/Источник_Архитектура|Источник_Архитектура]] — архитектурный blueprint
