...
источники:
  ...
  - "[[Источник_API]]"
доказательства:
  - "[[Focus/01_Человеку/Доказательства/QA_Результаты]]"
  - "[[Focus/01_Человеку/Доказательства/QA_Фиксы]]"
  - "[[QA_ТестКейсы_v2]]"
теги:
  - "focus"
  - "планировщик"
...
- `recurrence` — правила повторения ([[Focus/01_Человеку/Глоссарий/Recurrence_Rule]])
- `reminders` — правила напоминаний ([[Focus/01_Человеку/Глоссарий/Reminder_Rule]])
- `prioritypolicy` — автоснижение приоритета ([[Focus/01_Человеку/Глоссарий/Priority_Decay]])
...
См. подробности: [[Focus/01_Человеку/Доказательства/QA_Результаты]], [[Focus/01_Человеку/Доказательства/QA_Фиксы]], [[QA_ТестКейсы_v2]]
