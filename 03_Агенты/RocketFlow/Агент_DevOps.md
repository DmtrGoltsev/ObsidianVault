...
уверенность: "высокая"
источники: ["docs/58-github-cicd-policy.md", "docs/60-hexcore-prod-runbook.md", "docs/71-native-ios-delivery.md", "docs/33-current-state-summary.md", ".github/workflows/ios-verify.yml", "commit 0bbf4acb0ba9620b931fa843dc9d2997379304fb", "origin/master commit c0682493c93ac2d8ff1d31bca9e1b1c2546b3c56"]
...
Trigger fix доставлен в `origin/master` commit `c0682493c93ac2d8ff1d31bca9e1b1c2546b3c56` 2026-08-24: ровно `3 workflow files / 12 additions`; Android run `32766368686`, Backend `32766368744` и Web `32766368663` завершились success. iOS/deploy/publish не запускались. Candidate HEAD `99172cd171e8cade0545fb442c9233961c7865d1` имеет эквивалентную политику через `0bbf4acb0ba9620b931fa843dc9d2997379304fb`. Старые другие branches автоматически не исправлены и должны получить fix или быть retired. Genuine manual/PR/master failures могут уведомлять. Детали: [[MOC_DevOps]], общий порядок: [[Регламент_GitHub_Actions_без_лишних_запусков]].

Living docs зафиксированы на `99172cd171e8cade0545fb442c9233961c7865d1`: [`docs/58-github-cicd-policy.md`](https://github.com/DmtrGoltsev/RocketFlow/blob/99172cd171e8cade0545fb442c9233961c7865d1/docs/58-github-cicd-policy.md), [`docs/60-hexcore-prod-runbook.md`](https://github.com/DmtrGoltsev/RocketFlow/blob/99172cd171e8cade0545fb442c9233961c7865d1/docs/60-hexcore-prod-runbook.md), [`docs/71-native-ios-delivery.md`](https://github.com/DmtrGoltsev/RocketFlow/blob/99172cd171e8cade0545fb442c9233961c7865d1/docs/71-native-ios-delivery.md), [`docs/72-native-ios-mac-device-handoff.md`](https://github.com/DmtrGoltsev/RocketFlow/blob/99172cd171e8cade0545fb442c9233961c7865d1/docs/72-native-ios-mac-device-handoff.md).
...
- [[Регламент_GitHub_Actions_без_лишних_запусков]] — общий trigger policy и устранение лишних runs
