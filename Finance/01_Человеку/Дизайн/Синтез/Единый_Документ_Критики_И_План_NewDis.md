...
| Release evidence | Link final evidence into [[Finance/01_Человеку/Доказательства/QA_Фиксы]] or a new evidence note; update [[Пакет_Finance_Полный]] only after verified implementation. |
