...
источники:
  ...
  - "Local Git N8NAgents final reviewed source dd9e10a9b9b51e33761971e517a61a6bd9fa899c; tree 1d9dc11150e87846937b622748c95877f4823128; parent d163606a532529ab18cc6064a69d1fc7305b27cf; LOCAL_ONLY; NOT_DEPLOYED; source origin absent"
...
Эта заметка в canonical Obsidian vault — единственный human/agent-readable канонический архитектурный документ. Путь в source repository ниже служит только provenance адаптации; final local reviewed source `dd9e10a...` (parent `d163606a...`) содержит machine-consumed code/config/tests/contracts без tracked human-readable docs. Source repository не имеет `origin`; commit имеет статус `LOCAL_ONLY / NOT_DEPLOYED` и не upstream-published. Production AS-IS остается release `36e149...`; source metadata не заменяет production verification.
