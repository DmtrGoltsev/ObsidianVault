...
- [[Доказательство_E6_Internal_Rollout_STOP_20260828]] — exact internal rollout `STOP`: Compose bind sources разрешились от release root, PostgreSQL не стартовал, automatic recovery вернула `OLD=NONE`.
...
- [[Доказательство_E6_Internal_Rollout_STOP_20260828]] — redacted VPS evidence, failure state, empty quarantined PostgreSQL volume и corrective closure.
