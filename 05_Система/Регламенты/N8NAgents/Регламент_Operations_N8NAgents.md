...
| Назначение | Объект |
|---|---|
| Плагин OpenClaw | `n8nagents-actions` `0.1.3` |
...
После E2E 31 августа 2026 года:

- успешные выполнения Action API / materializer / confirmation с 10:00 UTC: `2 / 24 / 24`;
- выполняющиеся сценарии n8n: `0`;
- оба таймера активны, последние службы завершились успешно;
- OpenClaw и n8n работают, перезапуски: `0`;
- ожидающие обновления Telegram: `0`, `callback_query` разрешён.
