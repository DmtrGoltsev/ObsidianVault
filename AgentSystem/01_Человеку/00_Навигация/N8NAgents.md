...
# Платформа n8n: исторический контекст AgentSystem

> Это сохранённый контекст прежнего проекта `N8NAgents`. Канонический корень — [[AgentSystem]], первый активный агент — [[Poruchik]]. n8n продолжает работать в AgentSystem как интеграционная платформа; актуальная модель — [[21_Интеграция_OpenClaw_n8n_Актуальная_модель_2026-09-12]].
