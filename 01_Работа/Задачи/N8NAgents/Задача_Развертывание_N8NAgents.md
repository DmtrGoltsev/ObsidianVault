...
> Историческая задача раннего deployment cycle. Ее blockers и `NO-GO` не являются current status. Фактический production MVP принят; актуальные факты и незакрытая работа: [[CURRENT_STATE_N8NAgents_2026-08-29]] и [[Открытые_Задачи_N8NAgents_2026-08-29]].
