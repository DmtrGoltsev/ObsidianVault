...
- Backend: 20 фиксов применено (FIX-A — FIX-T), BE-101 исправлен
...
| Протестировано (Волны 1-9) | ~155 (61%) |
| PASS | ~149 |
...
- FCM push — заглушка, нужна реальная интеграция Firebase (Phase 3 nice-to-have)
